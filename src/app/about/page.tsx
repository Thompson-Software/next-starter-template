...
const HeartIcon = () => (
	<svg className="w-12 h-12 mx-auto mb-6 text-[var(--secondary)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
			...
			<main>
						...
						<div className="max-w-[800px] mx-auto text-center">
							...
							<div className="flex justify-center gap-12 flex-wrap">
								<div className="text-center">
									...
									<div className="text-[var(--text-secondary)] text-sm">Data points in cloud</div>
								</div>
								<div className="text-center">
									<div className="text-4xl font-extrabold gradient-text mb-2">100%</div>
									<div className="text-[var(--text-secondary)] text-sm">Local storage</div>
								</div>
								<div className="text-center">
									<div className="text-4xl font-extrabold gradient-text mb-2">∞</div>
									<div className="text-[var(--text-secondary)] text-sm">Privacy commitment</div>
								</div>
							</div>
						</div>
					</div>
				...
				<section className="py-24 bg-[var(--background)]">
					<div className="container">
						...
						<div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-8">
							<div className="bg-[var(--surface)] p-8 rounded-2xl border border-[var(--border)] text-center transition-all duration-300 hover:translate-y-[-5px] hover:border-[var(--secondary)] hover:shadow-[0_10px_30px_rgba(236,72,153,0.2)]">
								<ChipIcon />
								<h3 className="text-xl font-semibold mb-3 text-[var(--text)]">Privacy-Conscious Users</h3>
								<p className="text-[var(--text-secondary)] leading-relaxed">If you&apos;re concerned about data privacy and want to keep your health information secure, Luna is designed for you. Your data never leaves your device.</p>
							</div>
							<div className="bg-[var(--surface)] p-8 rounded-2xl border border-[var(--border)] text-center transition-all duration-300 hover:translate-y-[-5px] hover:border-[var(--secondary)] hover:shadow-[0_10px_30px_rgba(236,72,153,0.2)]">
								<ClockIcon />
								<h3 className="text-xl font-semibold mb-3 text-[var(--text)]">Busy Professionals</h3>
								<p className="text-[var(--text-secondary)] leading-relaxed">Quick logging, smart predictions, and no account setup means you can start tracking immediately without wasting time on sign-ups.</p>
							</div>
							<div className="bg-[var(--surface)] p-8 rounded-2xl border border-[var(--border)] text-center transition-all duration-300 hover:translate-y-[-5px] hover:border-[var(--secondary)] hover:shadow-[0_10px_30px_rgba(236,72,153,0.2)]">
								<HeartIcon />
								<h3 className="text-xl font-semibold mb-3 text-[var(--text)]">Health Enthusiasts</h3>
								<p className="text-[var(--text-secondary)] leading-relaxed">Track BBT, cervical mucus, and symptoms to gain deeper insights into your cycle patterns and overall health.</p>
							</div>
							<div className="bg-[var(--surface)] p-8 rounded-2xl border border-[var(--border)] text-center transition-all duration-300 hover:translate-y-[-5px] hover:border-[var(--secondary)] hover:shadow-[0_10px_30px_rgba(236,72,153,0.2)]">
								<UsersIcon />
								<h3 className="text-xl font-semibold mb-3 text-[var(--text)]">Anyone Who Values Privacy</h3>
								<p className="text-[var(--text-secondary)] leading-relaxed">Whether you&apos;re tracking for fertility, health, or just awareness, Luna ensures your personal data stays personal.</p>
							</div>
						</div>
					</div>
				</section>
				...
				<section className="py-24 bg-[var(--surface)]">
					<div className="container">
						...
						<p className="text-[var(--text-secondary)] text-center text-lg mb-12">See how Luna stacks up against other period tracking apps</p>
						<div className="max-w-[800px] mx-auto border border-[var(--border)] rounded-xl overflow-hidden">
							<div className="grid grid-cols-3 bg-[var(--background)] border-b border-[var(--border)]">
								<div className="p-4 text-center text-[var(--text)] font-semibold">Feature</div>
								<div className="p-4 text-center text-[var(--secondary)] font-semibold">Luna</div>
								<div className="p-4 text-center text-[var(--text)] font-semibold">Other Apps</div>
							</div>
							{[
								...
								<div key={idx} className="grid grid-cols-3 border-b border-[var(--border)] last:border-b-0">
									<div className="p-4 text-center text-[var(--text-secondary)] font-medium">{row[0]}</div>
									<div className="p-4 text-center text-[var(--success)] font-semibold">{row[1]}</div>
									<div className="p-4 text-center text-[var(--text-secondary)] font-medium">{row[2]}</div>
								</div>
							))}
							</div>
						</div>
					...
					<div className="container">
						...
						<div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8">
							{[
								...
								<div key={idx} className="bg-[var(--surface)] p-8 rounded-2xl border border-[var(--border)] relative overflow-hidden">
									<div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[var(--primary)] via-[var(--secondary)] to-[var(--blue)]"></div>
									<div className="text-5xl font-extrabold gradient-text mb-4 opacity-30">{benefit.num}</div>
									<h3 className="text-xl font-semibold mb-3 text-[var(--text)]">{benefit.title}</h3>
				...
				{/* Download Section */}
				<section className="py-24 bg-[var(--surface)] text-center">
					<div className="container">
						<h2 className="text-4xl font-bold mb-4 gradient-text">Ready to Take Control?</h2>
						<p className="text-[var(--text-secondary)] text-xl mb-8">Download Luna today and experience period tracking with true privacy</p>
						...
						<p className="text-[var(--text-secondary)] text-sm">iOS 15.0+ • Android 8.0+ • Free forever</p>
					</div>
				</section>
			</main>
			<Footer />
