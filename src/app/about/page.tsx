...
const HeartIcon = () => (
	<svg className="w-12 h-12 mx-auto mb-6 text-secondary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
			...
			<main>
				...
				<section className="py-16 sm:py-24 bg-surface text-center">
					<div className="container">
						...
						<p className="text-text-secondary text-sm">iOS 15.0+ • Android 8.0+ • Free forever</p>
					</div>
				</section>
			</main>
			<Footer />
