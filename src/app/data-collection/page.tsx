				...
				<div className="container max-w-[800px]">
					...
					<div className="space-y-10">
						<section className="pb-10 border-b border-border">
							...
							<div className="bg-surface border border-[var(--primary)] rounded-xl p-6">
					...
					<div className="text-center mt-12 pt-8 border-t border-border">
						<Link href="/" className="inline-flex items-center justify-center px-6 py-3 rounded-full font-semibold transition-all duration-300 bg-surface text-text border border-border hover:border-[var(--primary)] hover:translate-y-[-2px]">
							Back to Home
						</Link>
					</div>
				</div>
