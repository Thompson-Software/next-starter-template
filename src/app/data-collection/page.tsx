				...
				<div className="container max-w-[800px]">
					...
					<div className="space-y-10">
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">Current Data Collection Status</h2>
							...
							<div className="bg-[var(--color-surface)] border border-[var(--primary)] rounded-xl p-6">
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">What This Means for You</h2>
							<p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">Because Luna collects no data:</p>
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">Future Analytics (Opt-In Only)</h2>
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">Contact Us</h2>
