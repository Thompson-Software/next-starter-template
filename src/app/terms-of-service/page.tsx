				...
				<div className="container max-w-[800px]">
					...
					<div className="space-y-10">
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">1. Acceptance of Terms</h2>
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">2. Health Disclaimer</h2>
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">3. Data and Privacy</h2>
							<p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">4. Contact Information</h2>
							<p className="text-[var(--color-text-secondary)] leading-relaxed">
