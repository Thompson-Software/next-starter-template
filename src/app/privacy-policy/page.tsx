			...
			<main className="pt-32 pb-16 px-4 min-h-screen">
				<div className="container max-w-[800px]">
					<div className="text-center mb-12">
						...
						<p className="text-[var(--color-text-secondary)]">Last updated: May 2026</p>
					</div>

					<div className="space-y-10">
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">1. Our Privacy Commitment</h2>
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">2. Data Storage</h2>
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">3. Data We Do NOT Collect</h2>
							<p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">Luna does NOT collect:</p>
							<ul className="list-none space-y-2 text-[var(--color-text-secondary)]">
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">4. Data Sharing</h2>
							<p className="text-[var(--color-text-secondary)] leading-relaxed">
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">5. On-Device Machine Learning</h2>
							<p className="text-[var(--color-text-secondary)] leading-relaxed">
						...
						<section className="pb-10 border-b border-[var(--color-border)]">
							<h2 className="text-2xl font-semibold mb-4 text-[var(--color-text)]">6. Contact Us</h2>
							<p className="text-[var(--color-text-secondary)] leading-relaxed">
					...
					<div className="text-center mt-12 pt-8 border-t border-[var(--color-border)]">
						<Link href="/" className="inline-flex items-center justify-center px-6 py-3 rounded-full font-semibold transition-all duration-300 bg-[var(--color-surface)] text-[var(--color-text)] border border-[var(--color-border)] hover:border-[var(--primary)] hover:translate-y-[-2px]">
							Back to Home
						</Link>
					</div>
				</div>
